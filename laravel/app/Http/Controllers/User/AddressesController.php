...
class AddressesController extends Controller
{
    ...
    public function index(Address $address)
    {
        ...
        $regions = DB::table('regions')->where('city_id',$cities->first()->id)->get();

        return view('user.addresses.index', compact('addresses', 'provinces', 'cities','regions'));
...
//        $id=$address->user_id;
//        dd($id);
//        $addr=DB::table('addresses')->where('user_id',$id)->get();
//        dd($addr);
//        $provinces =$addr->prvince;
//        $cities = $addr->city;
//      // echo $cities;
//        $regions =$addr->region;
//        //echo $regions;
//        return view('user.addresses.index', compact('addresses', 'provinces', 'cities','regions'));
    ...
    public function edit(Address $address)
    {
        ...
        $cities = DB::table('cities')->where('province_id', $provinces->first()->id)->get();
        $regions = DB::table('regions')->where('city_id',$cities->first()->id)->get();
        return view('user.addresses.edit', compact('addresses', 'address','provinces','cities','regions'));
    }
    ...
    {
        return DB::table('regions')->where('city_id', $request->input('city_id'))->get();
    }
}
