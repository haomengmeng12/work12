                ...
                <div class="tb-detail-list">
                    ...
                    <div class="tb-detail-price">
                        <li class="price iteminfo_price">
                            <dt>课程价格</dt>
                            <dd><b class="sys_item_price">{{ $product->price }}</b><em>￥</em>  </dd>
                        </li>
                    ...
                    <dl class="iteminfo_parameter freight">
                        ...
                        <div class="iteminfo_freprice">
                            <div class="am-form-content address">
                                ...
                                @else
                                    <a style="line-height:27px;color:red;" href="{{ url('user')  }}">添加教学地址</a>
                                @endif
                    ...
                    <dl class="iteminfo_parameter sys_item_specpara">
                        ...
                        <dd>
                                        ...
                                        <div class="theme-signin-left">
                                            ...
                                            <div class="theme-options">
                                                <div class="cart-title number">数量</div>
                                                 <dd>
                                                    <input id="min" class="am-btn am-btn-default" type="button" value="选课程" />
                                                    <input id="text_box" name="numbers" type="text" value="50" style="width:30px;" />
                            ...
                            {{--<input id="add" class="am-btn am-btn-default"  type="button" value="+" />--}}
                                                <span id="Stock" class="tb-hidden">课程容量<span class="stock">{{ $product->productDetail->count }}</span>人</span>
                                                </dd>
                                            </div>
                    </dl>
